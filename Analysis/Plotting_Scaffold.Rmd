...
plot(x=1:length(WmeanVar), y=WmeanVar, type="l", xlab="time", ylab="Abundace-Weighted Mean Trait Variance", main="Plants")
...
plot(x=1:length(WmeanVar), y=WmeanVar, type="l", xlab="time", ylab="Abundace-Weighted Mean Trait Variance", main="Animals")
```
