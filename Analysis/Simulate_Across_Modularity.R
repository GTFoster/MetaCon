...
runSimulation <- function() {
  ...
  x1 <- try(runDispersalSim(nsites = nsites, disptype = "negativeComp", n_plants = 5, n_animals = 5, dexpsim = as.matrix(as_adjacency_matrix(nets[[1]]$net, attr="weight")), r = 0.5, mup = 0.1, mua = 0.1, o = 0.1, lambda = 0.9, K = 500, e_thresh = 2, invade_size = 5, disprobmax = 0.2, num_timeSteps = 500, invProb = 0.05))
  x2 <- try(runDispersalSim(nsites = nsites, disptype = "negativeComp", n_plants = 5, n_animals = 5, dexpsim = as.matrix(as_adjacency_matrix(nets[[2]]$net, attr="weight")), r = 0.5, mup = 0.1, mua = 0.1, o = 0.1, lambda = 0.9, K = 500, e_thresh = 2, invade_size = 5, disprobmax = 0.2, num_timeSteps = 500, invProb = 0.05))
  x3 <- try(runDispersalSim(nsites = nsites, disptype = "negativeComp", n_plants = 5, n_animals = 5, dexpsim = as.matrix(as_adjacency_matrix(nets[[3]]$net, attr="weight")), r = 0.5, mup = 0.1, mua = 0.1, o = 0.1, lambda = 0.9, K = 500, e_thresh = 2, invade_size = 5, disprobmax = 0.2, num_timeSteps = 500, invProb = 0.05))
...
save(list_results, file="simulationNegative_testsites_Mod_Fixed0.Rda")
...
runSimulation <- function() {
  nets <- simModularity(nsites=100, wi=0.4, ac=0.01)
  x1 <- try(runDispersalSim(nsites = nsites, disptype = "positiveComp", n_plants = 5, n_animals = 5, dexpsim = as.matrix(as_adjacency_matrix(nets[[1]]$net, attr="weight")), r = 0.5, mup = 0.1, mua = 0.1>
  x2 <- try(runDispersalSim(nsites = nsites, disptype = "positiveComp", n_plants = 5, n_animals = 5, dexpsim = as.matrix(as_adjacency_matrix(nets[[2]]$net, attr="weight")), r = 0.5, mup = 0.1, mua = 0.1>
  x3 <- try(runDispersalSim(nsites = nsites, disptype = "positiveComp", n_plants = 5, n_animals = 5, dexpsim = as.matrix(as_adjacency_matrix(nets[[3]]$net, attr="weight")), r = 0.5, mup = 0.1, mua = 0.1>
  return(list(high=x1, med=x2, low=x3, mods=c(nets[[1]]$mode,nets[[2]]$mode,nets[[3]]$mode)))
}
...
save(list_results, file="simulationPositive_100sites_Mod_Fixed0.Rda")
...
runSimulation <- function() {
  nets <- simModularity(nsites=100, wi=0.4, ac=0.01)
  x1 <- try(runDispersalSim(nsites = nsites, disptype = "neutralComp", n_plants = 5, n_animals = 5, dexpsim = as.matrix(as_adjacency_matrix(nets[[1]]$net, attr="weight")), r = 0.5, mup = 0.1, mua = 0.1>
  x2 <- try(runDispersalSim(nsites = nsites, disptype = "neutralComp", n_plants = 5, n_animals = 5, dexpsim = as.matrix(as_adjacency_matrix(nets[[2]]$net, attr="weight")), r = 0.5, mup = 0.1, mua = 0.1>
  x3 <- try(runDispersalSim(nsites = nsites, disptype = "neutralComp", n_plants = 5, n_animals = 5, dexpsim = as.matrix(as_adjacency_matrix(nets[[3]]$net, attr="weight")), r = 0.5, mup = 0.1, mua = 0.1>
  return(list(high=x1, med=x2, low=x3, mods=c(nets[[1]]$mode,nets[[2]]$mode,nets[[3]]$mode)))
}
...
save(list_results, file="simulationNeutral_100sites_Mod_Fixed0.Rda")
