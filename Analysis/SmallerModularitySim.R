...
save(list_results, file="simulationNegative_100sites_Mod_seed0.Rda")
...
save(list_results, file="simulationPositive_100sites_Mod_seed0.Rda")
...
save(list_results, file="simulationNeutral_100sites_Mod_seed0.Rda")
