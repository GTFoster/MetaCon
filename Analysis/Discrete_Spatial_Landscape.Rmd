...
list()
ret <- list(plants=p_pops_output, animals=a_pops_output, a_traitsM=a_traitM, a_traitV=a_traitV, p_traitsM=p_traitM, p_traitV=p_traitV)
...
```{r}
exampleob <- list(p_pops=p_pops_output, a_pops=a_pops_output, a_traitMean=a_traitM, a_traitVar=a_traitV, p_traitMean=p_traitM, p_traitVar=p_traitV)
#save(exampleob, file="exampleOutput.Rda")
```
